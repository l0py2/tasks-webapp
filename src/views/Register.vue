<template>
	<main>
		<section>
			...
			<form @submit.prevent="register">
				...
				<button :disabled="!(auth.username.valid && auth.password.valid)">Register</button>
			</form>
	...
	<Modal :show="show.modal" @close="show.modal = false">
		...
		<template #body>Username already in use</template>
	</Modal>
</template>
...
export default {
	...
	setup() {
		document.title = 'Task[\'s\'] - Register';
